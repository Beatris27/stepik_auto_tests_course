...
class TestAliens:
    def test_aliens_task(self, browser, links):
        ...
        button_enter = browser.find_element(By.LINK_TEXT, "Войти")  # нажимаем на кнопку авторизации на сайте
        button_enter.click()

        input_email = browser.find_element(By.ID, "id_login_email")  # вводим логин
        input_email.send_keys("ya.n-bog@ya.ru")

        input_password = browser.find_element(By.ID, "id_login_password")
        input_password.send_keys("30061988")  # вводим пароль
